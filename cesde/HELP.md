...
* [Rest Repositories](https://docs.spring.io/spring-boot/3.4.4-SNAPSHOT/how-to/data-access.html#howto.data-access.exposing-spring-data-repositories-as-rest)
...
* [Spring Security](https://docs.spring.io/spring-boot/3.4.4-SNAPSHOT/reference/web/spring-security.html)
* [JDBC API](https://docs.spring.io/spring-boot/3.4.4-SNAPSHOT/reference/data/sql.html)
* [Spring Data JPA](https://docs.spring.io/spring-boot/3.4.4-SNAPSHOT/reference/data/sql.html#data.sql.jpa-and-spring-data)
* [Spring Data JDBC](https://docs.spring.io/spring-boot/3.4.4-SNAPSHOT/reference/data/sql.html#data.sql.jdbc)
